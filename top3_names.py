# Задание «Узнайте топ-3 популярных имён» из блока "Коллекции данных. Множества."

def main(mentors, courses):
    all_list = []
    for m in mentors:
        all_list.extend(m)
    ...
    top_3 = popular[:3]
    output = ', '.join([f"{name}: {count} раз(а)" for name, count in top_3])
    return output
